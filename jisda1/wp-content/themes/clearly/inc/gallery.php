 ...
 * @return string
 */
function clearly_gallery($contents, $attr){
	...
	foreach($attachments as $attachment){
		$return .= '<li>';
		$return .= apply_filters('clearly_slide_before', '', $attachment);
		...
		$return .= apply_filters('clearly_slide_after', '', $attachment);
		$return .= '</li>';
	}
	$return .= '</ul>';
	$return .= '</div>';
...
add_filter('post_gallery', 'clearly_gallery', 10, 2);
 ...
 * @since clearly 1.0
 */
function clearly_gallery_types($types){
	$types['slider'] = __('Slider', 'clearly');
	return $types;
}
add_filter('siteorigin_gallery_types', 'clearly_gallery_types');
 ...
 * @since clearly 1.0
 */
function clearly_gallery_default_type(){
	return 'slider';
}
add_filter('siteorigin_gallery_default_type', 'clearly_gallery_default_type');