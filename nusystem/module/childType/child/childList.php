...
<table class="table table-striped table-hover table-bordered">
        ...
        while($row = mysqli_fetch_array($query)){
                ...
                $ct_id = $row['ct_id'];
                $ct_detail = str_replace("\'", "&#39;", $row["ct_detail"]);
        ?>
            <tr>
                <td align="left">
                    <a href="#" data-toggle="modal" data-target="#myModal<?php echo $ct_id ?>">
                        <?= $ct_name ?>
                    </a>
                    
                        <!-- Modal -->
                        <div class="modal fade" id="myModal<?php echo $ct_id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel<?php echo $ct_id ?>">
