...
?>
    ...
    <table class="table table-striped table-hover table-bordered">
        ...
        ?>
                ...
                <td align="center"><a href="?page=user&&userpage=edit&&id=<?= $row['u_id'] ?>"><span class="glyphicon glyphicon-edit"></span></a> | <a href="?page=user&&userpage=delete&&id=<?= $row['u_id'] ?>" onclick="return confirm('คุณเเน่ใจหรือไม่ว่าจะลบข้อมูลนี้ ?');" ><span class="glyphicon glyphicon-remove"></span></a></td>
            </tr>
        <?php        
        }
        mysqli_close($con);
