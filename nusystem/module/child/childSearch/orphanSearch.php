...
<div class="pull-right">
        <form class="navbar-form" role="search" action="?page=child&&cpage=orphanSearch" method="post">
...
<table class="table">
  <tbody>
    ...
    $sql = "SELECT c.*,ct.*,cp.* FROM childs c
                              ...
                              WHERE (c.c_fname LIKE '%".$q."%' and ct.ct_category = '1' ) OR (c.c_fatherName LIKE '%".$q."%' and ct.ct_category = '1' ) OR (c.c_motherName LIKE '%".$q."%' and ct.ct_category = '1' ) OR (c.c_pFname LIKE '%".$q."%' and ct.ct_category = '1' )
                              ORDER BY c_id DESC";
