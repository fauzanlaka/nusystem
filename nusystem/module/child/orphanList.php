<?php
$pagic = "?page=child&&cpage=orphanList";
$sql = "SELECT COUNT(c.c_id),c.*,ct.* FROM childs c INNER JOIN childType ct ON c.ct_id=ct.ct_id WHERE ct.ct_category='1'";
