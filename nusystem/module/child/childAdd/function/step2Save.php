<?php
    ...
    $INSERT = mysqli_query($con, "UPDATE childs SET
                          ...
                          c_relegionSchoolDistrict='$relegionSchoolprovince',
                          c_relegionSchoolprovince='$relegionSchoolPost',
                          c_relegionSchoolPost='$copoiesHouseNumber',
                          c_copoiesHouseNumber='$copiesPlaceNumber',
