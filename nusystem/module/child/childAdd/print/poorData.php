...
<html lang="en">
	...
	<body>
            ...
            <?php
                ...
                $c_fBirdthDate = str_replace("\'", "&#39;", $rChild["c_fBirdthDate"]);
                $c_fJob = str_replace("\'", "&#39;", $rChild["c_fJob"]);
                $c_fRevenue = str_replace("\'", "&#39;", $rChild["c_fRevenue"]);
                
                //Age
                $c = date('Y');
                $f = substr($rChild['c_fBirdthDate'],0,4);
                $fAge = $c-$f;
                
                $c_motherName = str_replace("\'", "&#39;", $rChild["c_motherName"]); 
                $c_motherLname = str_replace("\'", "&#39;", $rChild["c_motherLname"]);
                $c_mBirdthDate = str_replace("\'", "&#39;", $rChild["c_mBirdthDate"]);
                $c_mJob = str_replace("\'", "&#39;", $rChild["c_mJob"]);
                $c_mRevenue = str_replace("\'", "&#39;", $rChild["c_mRevenue"]);
                
                //Age
                $c = date('Y');
                $m = substr($rChild['c_mBirdthDate'],0,4);
                $mAge = $c-$m;
            ...
            <div id="printableArea">
                     ...
                     <div class="pull-right">
                         ...
                         <p><i>บิดา</i></p>
                         <p>ชื่อ-นามสกุล : <i><u><?= $c_fatherName  ?></u></i> <i><u><?= $c_fatherLname  ?></u></i> </p>
                         <p>วัน/เดือน/ปี (เกิด) : <i><u><?= $c_fBirdthDate  ?></u></i>  อายุ : <i><u><?= $fAge ?></u></i> ปี</p>
                         <p>อาชีพ : <i><u><?= $c_fJob ?></u></i> รายได้ : <i><u><?= $c_fRevenue ?></u></i></p>
                         ...
                         <p>วัน/เดือน/ปี (เกิด) : <i><u><?= $c_mBirdthDate  ?></u></i> อายุ : <i><u><?= $mAge ?></u></i> ปี</p>
                         <p>อาชีพ : <i><u><?= $c_mJob ?></u></i> รายได้ : <i><u><?= $c_mRevenue ?></u></i></p>
                       
                         <p><b>7. สถานภาพปัจจุบันของครอบครัว</b></p>
