<br>
<div class="pull-left">
        <a href="index.php?page=add" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-arrow-left"></span> BACK</a>
</div>
<p align="center"><img src="image/jisda.png" class="img-responsive" alt="Responsive image" width="150px" height="1px"></p>
<h4 align="center"><f class="main">جامعة اسلام شيخ داودالفطانى - جالا</f></h4>
        ...
        <div class="panel-body">
            <form class="form-horizontal" action="?page=saveStep1" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="Penyakit pembawaan" name="infection">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="Nama" name="fatherName">
                    </div>
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="Nasab" name="fatherLastname">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="Pekerjaan bapa" name="fatherJob">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="Nama" name="motherName">
                    </div>
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="Nasab" name="motherLastname">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="Pekerjaan ibu" name="motherJob">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="หมู่บ้าน" name="t_village_name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        <input type="text" class="form-control input-sm" placeholder="บ้านเลขที่" name="house_number">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        <input type="text" class="form-control input-sm" placeholder="หมู่ที่" name="place">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="ถนน" name="t_road">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="ตำบล" name="t_subdistrict">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="อำเภอ" name="t_district">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="จังหวัด" name="t_province_sec">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="รหัสไปรษณีย์" name="post">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="โทรศัพท์" name="telephone">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <div class="input_container">
                            <input type="text" class="form-control input-sm" placeholder="نام سكوله توليسن عرب" name="ibtidai" id="country_id3" onkeyup="autocomplet3()">
                            <ul id="country_list_id3"></ul>
                        </div>
                    </div>
                    <label class="col-lg-1 control-label">Kampong</label>
                    <div class="col-lg-2">
                        <input type="text" class="form-control input-sm" placeholder="ترلتق  دکمفوڠ" name="ibtidaiVillage">
                    </div>
                    <label class="col-lg-1 control-label">Tahun</label>
                    <div class="col-lg-2">
                        <input type="text" class="form-control input-sm" placeholder="Contoh : 2015" name="ibtidaiYear">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <div class="input_container">
                            <input type="text" class="form-control input-sm" placeholder="نام سكوله توليسن عرب" name="mutawassit" id="country_id2" onkeyup="autocomplet2()">
                            <ul id="country_list_id2"></ul>
                        </div>
                    </div>
                    <label class="col-lg-1 control-label">Kampong</label>
                    <div class="col-lg-2">
                        <input type="text" class="form-control input-sm" placeholder="ترلتق  دکمفوڠ" name="mutawassitVillage">
                    </div>
                    <label class="col-lg-1 control-label">Tahun</label>
                    <div class="col-lg-2">
                        <input type="text" class="form-control input-sm" placeholder="Contoh : 2015" name="mutawassitYear">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <div class="input_container">
                            <input type="text" class="form-control input-sm" placeholder="نام سكوله توليسن عرب" name="sanawi" id="country_id" onkeyup="autocomplet()">
                            <ul id="country_list_id"></ul>
                        </div>
                    </div>
                    <label class="col-lg-1 control-label">Kampong</label>
                    <div class="col-lg-2">
                        <input type="text" class="form-control input-sm" placeholder="ترلتق  دکمفوڠ" name="sanawiVillage">
                    </div>
                    <label class="col-lg-1 control-label">Tahun</label>
                    <div class="col-lg-2">
                        <input type="text" class="form-control input-sm" placeholder="Contoh : 2015" name="sanawiYear" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="ชื่อโรงเรียนเป็นภาษาไทย" name="primaryschool">
                    </div>
                    <label class="col-lg-1 control-label">ปีที่จบ</label>
                    <div class="col-lg-2">
                        <input type="text" class="form-control input-sm" placeholder="Contoh : 2015" name="primaryschoolYear">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="ชื่อโรงเรียนเป็นภาษาไทย" name="firsthightschool">
                    </div>
                    <label class="col-lg-1 control-label">ปีที่จบ</label>
                    <div class="col-lg-2">
                        <input type="text" class="form-control input-sm" placeholder="Contoh : 2015" name="firsthightschoolYear">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control input-sm" placeholder="ชื่อโรงเรียนเป็นภาษาไทย" name="lastthightschool">
                    </div>
                    <label class="col-lg-1 control-label">ปีที่จบ</label>
                    <div class="col-lg-2">
                        <input type="text" class="form-control input-sm" placeholder="Contoh : 2015" name="lastthightschoolYear">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <select class="form-control input-sm" name="first_sid" required>
                            ...
                            <option value="22">-------> Pendidikan agama islam</option>
                            <option value="23">-------> Pendidikan bahasa dan sastera melayu</option>
                            <option value="122">2.Syariah islamiah</option>
                            <option value="123">3.Usuluddin</option>
                            <option value="124">4.Dirasat islamiah wa al-arabiah</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
            ...
            <input type="hidden" name="nama" value="fauzan">
