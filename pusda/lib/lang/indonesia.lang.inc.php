...
define('lang_sys_barcodes', 'Pembuat Kode Batang');
define('lang_sys_barcodes_titletag', 'Pembuat Kode Batang');
define('lang_sys_barcodes_description', 'Ketik teks kode batang dalam kotak di bawah ini dan klik');
...
define('lang_sys_common_form_save_change', 'Simpan Perubahan'); /* proposed */
...
/* Barcode Generator */
define('lang_sys_conf_barcode_alert_print_fail', 'GAGAL mencetak kode batang!');
define('lang_sys_conf_barcode_alert_print_ok', 'Pencetakan kode batang selesai');
define('lang_sys_conf_barcode_button_print', 'Cetak Kode Batang');
define('lang_sys_conf_barcode_field_size', 'Ukuran Kode Batang');
...
define('lang_mod_biblio_tools_item_barcode', 'Cetak Kode Batang Koleksi');
define('lang_mod_biblio_tools_item_barcode_titletag', 'Cetak Kode Batang Koleksi');
...
define('lang_mod_biblio_field_topic', 'Topik/Subjek');
define('lang_mod_biblio_link_topic_add', 'Tambah Data Topik/Subjek');
...
define('lang_mod_biblio_item_field_site', 'Penempatan');
...
# topic
define('lang_mod_biblio_topic_update_ok', 'Topik berhasil diperbaharui!');
define('lang_mod_biblio_topic_added_ok', 'Topik berhasil ditambahkan!');
define('lang_mod_biblio_topic_added_fail', 'Topik GAGAL Ditambahkan. Hubungi System Administrator');
define('lang_mod_biblio_topic_form_title', 'Tambahkan Topik');
...
define('lang_mod_circ_alert_member_expired', 'DILARANG meminjam! Keanggotaan sudah habis atau dibatalkan sementara!');
...
define('lang_mod_masterfile_topic', 'Topik');
define('lang_mod_masterfile_topic_titletag', 'Topik Dokumen');
define('lang_mod_masterfile_topic_new_add', 'Tambah Topik Baru');
define('lang_mod_masterfile_topic_list', 'Daftar Topik');
...
define('lang_mod_masterfile_publisher_form_field_place', 'Tempat Penerbit');
...
# topic master file
# common
define('lang_mod_masterfile_topic_alert_name_noempty', 'Topik tidak boleh kosong');
define('lang_mod_masterfile_topic_alert_new_add_ok', 'Topik Baru Berhasil Disimpan');
define('lang_mod_masterfile_topic_alert_add_fail', 'Topik GAGAL Disimpan. Hubungi admin sistem untuk pemecahannya');
define('lang_mod_masterfile_topic_alert_update_ok', 'Data Topik Berhasil Diperbaharui');
define('lang_mod_masterfile_topic_alert_update_fail', 'Topik GAGAL Diperbaharui. Hubungi admin sistem untuk pemecahannya');
define('lang_mod_masterfile_topic_alert_not_exists', 'ERROR! Data terpilih tidak ditemukan');
define('lang_mod_masterfile_topic_common_edit_info', 'Anda akan meng-edit data Suplaiyer data');
...
# form
define('lang_mod_masterfile_topic_form_field_name', 'Topik');
...
define('lang_mod_stocktake_init_field_site', 'Letak/Penempatannya');
