...
<head>
    ...
    <title>ADMIN | Tambah fakulti</title>
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <h4><span class="glyphicon glyphicon-bookmark"><b> Tambah fakulti</b></span></h4>
                        <hr>
                        <p>
                    ...
                    <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="function/save_add_faculty.php"><!-- Form -->
                      
						<div class="form-group">
								<label for="Inputname" class="col-sm-3">Fakulti :</label>
									<div class="col-sm-5">
										<input type="text" class="form-control" id="ft_name" name="ft_name" placeholder="Ex : Tarbiah" required onBlur="ftnamecheck()" >
						...
						<div class="form-group">
								<label for="Input_fakulty" class="col-sm-3">Perinci :</label>
									<div class="col-sm-5">
										<textarea class="form-control" id="ft_describe" name="ft_describtion" required ></textarea>
									</div>
						</div>
									
						<div class="form-group">
							<label for="Iputfacultycode" class="col-sm-3">Kode fakulti :</label>
							<div class="col-sm-2">
								<input type="text" name="ft_code" class="form-control" id="ft_code" placeholder="EX: TA001" required onBlur="checkftcode()">
							</div>
