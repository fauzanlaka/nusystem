            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <h4><span class="glyphicon glyphicon-list-alt"><b> Tambah pendaftran ujian</b></span></h4>
                        <hr>
                        <!-- Post list -->
					 ...
					 <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="<?= saveexam(); ?>"><!-- Form -->
						...
						<div class="form-group">
								<label for="Input_fakulty" class="col-sm-3">Harga daftar :</label>
									<div class="col-sm-3">
										<input type="text" name="prize" class="form-control" placeholder="BTH" required>
									</div>
						</div>
