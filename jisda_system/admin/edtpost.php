            ...
            <div class="col-md-9"><!-- col-md-9 Content body -->
            	<div class="panel panel-success"><!-- Panel success--> 
                    <div class="panel-heading"><!-- Panel heading-->
                    	<h3 class=" panel-title"><span class="glyphicon glyphicon-edit"></span> Ubah post</h3>
                    </div><!-- /.Panel heading-->    
                    <div class="panel-body"><!-- Panel body-->
                        ...
                        ?>
                        <form class="form-horizontal" role="form" action="<?php edtpost(); ?>" method="post" enctype="multipart/form-data">
                        	<div class="form-group">
                            	<label for="Input-post-title" class="col-sm-2">Tajuk :</label>
                            	<div class="col-sm-9">
                            	<input type="text" class="form-control" id="p_title" name="p_title" placeholder="Tajuk maklumat" value="<?= $title; ?>">
                            	</div>
                            </div>
                            <div class="form-group">
                            	<label for="input_post" class="col-sm-2">Maklumat :</label>
 								<div class="col-sm-9"> 
                                	<textarea id="p_post" name="p_post" class="form-control" rows="8" style="width:100%" required><?= $post; ?></textarea> 
                            	</div>
                            </div>
							<div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                	<input type="text" id="p_other" name="p_other" class="form-control" placeholder="Peringatan" value="<?= $other; ?>">
                                </div>
                            </div>
							<div class="form-group">
                                ...
                                <div class="col-sm-3">
                                	<select name="publish" class="form-control">
										<option <?php $v = "0"; if($v == $publish){ echo "selected='selected'"; } ?> value="0">Tidak publik</option>
										<option <?php $v = "1"; if($v == $publish){ echo "selected='selected'"; } ?> value="1">Umum</option>
										<option <?php $v = "2"; if($v == $publish){ echo "selected='selected'"; } ?> value="2">Mahasiswa</option>
										<option <?php $v = "3"; if($v == $publish){ echo "selected='selected'"; } ?> value="3">Guru</option>
									</select>
                                </div>
                            </div>
                            <a href="plist.php"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-arrow-left"></span> Back</button></a>
