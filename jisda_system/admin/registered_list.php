    ...
    <div class="container">
        ...
        <div class="row">
			...
			<!-- Users query --> 
                        <?php 
                            include("connect.php");
                            $strSQL = "select sr.*,st.*,re.*,p.* from student_register sr inner join students st on sr.st_id = st.st_id inner join register re on sr.re_id = re.re_id inner join payments p on sr.sr_id=p.sr_id where pay_status = 'Sudah bayar' ORDER BY p_id DESC LIMIT 0,15 ";
