        ...
        <div class="row"><!-- Row -->
            ...
            <div class="col-md-9"><!-- col-md-9 Content body -->
            	<div class="panel panel-success"><!-- Panel success--> 
                    ...
                    <div class="pull-right"><a href="user.php"><button type="button" name="add_user" class="btn btn-success"><span class="glyphicon glyphicon-th-list"></span> Daftar anggota</button></a>
                            <a href="add_user.php"><button type="button" name="add_user" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Tambah pengguna</button></a></div><br><br><br>
                        ...
                        <table>
                        	<tr>
                        		...
                        		<form class="form-horizontal" role="form" action="save_edit_user_profile.php" method="post" enctype="multipart/form-data" ><!-- Form -->
                            ...
                            <button type="submit" class="btn btn-success" name="save" ><span class="glyphicon glyphicon-floppy-saved"> Mengesahkan</button>
