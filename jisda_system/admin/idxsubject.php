...
<head>
    ...
    <title>ADMIN | Daftar mata kuliah</title>
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <h4><span class="glyphicon glyphicon-list-alt"><b> MATA KULIAH</b></span></h4>
                        <hr>
						...
						<?php
						include("connect.php");
						$strSQL = "select sj.*,tc.* from subjeck sj inner join teachers tc on sj.tc_id=tc.tc_id";
						...
						if($Num_Rows<=$Per_Page)
							...
							$strSQL .=" order  by sj_id DESC LIMIT $Page_Start , $Per_Page";
							$objQuery  = mysql_query($strSQL);
						?>
                <table>
               		<table class="table table-hover">
						...
						{
							$sj_code = str_replace("\'", "&#39;", $objResult['sj_code']);
							$sj_name = str_replace("\'", "&#39;", $objResult['sj_name']);
							$sj_unit = str_replace("\'", "&#39;", $objResult['sj_unit']);
						...
						?>
                         <tr>        
                             <td align="center"><?= $sj_code; ?></td>
                             <td align="center"><?= $sj_name; ?></td>
                             <td align="center"><?= $sj_unit; ?></td>
