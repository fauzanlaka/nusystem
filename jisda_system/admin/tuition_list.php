            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <h4><span class="glyphicon glyphicon-list-alt"><b> Daftar belajar</b></span></h4>
                        <hr>
                        <!-- Post list -->
                        ...
                        <?php 
							include("connect.php");
							$strSQL = "select r.*,y.*,t.*,d.* from register r inner join year y on r.y_id = y.y_id inner join term t on r.term_id = t.t_id inner join tuitionstatus d on r.tu_id = d.tu_id";
						...
						if($Num_Rows<=$Per_Page)
							...
							$strSQL .=" order by re_id DESC LIMIT $Page_Start , $Per_Page";
							$objQuery  = mysql_query($strSQL);
						?>
                <table>
               		<table class="table table-hover">
						...
						?>
                         <tr>        
                             <td align="center"><a href="edit_tuition.php?id=<?= $objResult['re_id']; ?>"><?= $academic_year; ?></a></td>
                             <td align="center"><?= $term; ?></td>
                             <td align="center"><?= $start_date; ?></td>
                             <td align="center"><?= $end_date; ?></td>
                             <td align="center"><?= $status; ?></td>
                             <td align="center"><a href="function/delete_tuition.php?id=<?= $objResult['re_id']; ?>"><span class="glyphicon glyphicon-trash"></span></a></td>
                         </tr>
						<?php } ?>
				</table>
<br>
