            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <h4><span class="glyphicon glyphicon-list-alt"><b> Muqaddimah</b></span></h4>
                        <hr>
                        <!-- Post list -->
			...
			<div class="pull-left">
                            <form class="navbar-form" role="search" action="no_registered_search.php" method="post">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Nomor pokok" name="student_id" required>
                        ...
                        <?php 
                            include("connect.php");
                            $sql_all = "select * from students LIMIT 0,12";
               		...
               		<table class="table table-hover">
                            <tr>
                                ...
                                <th><b>Tahun</b></td>
                                <th><b>Telepon</b></td>
                                <td align="center"><b>Status pembayaran</b></td>
                            </tr>
                            <?php 
                                while($result_all = mysql_fetch_array($query_all)){
                                    $student_id = str_replace("\'", "&#39;", $result_all['student_id']);
                                    $name = str_replace("\'", "&#39;", $result_all['firstname_rumi']);
                                    $lastname = str_replace("\'", "&#39;", $result_all['lastname_rumi']);
                                    $year = str_replace("\'", "&#39;", $result_all['income_year']);
                                    $telephone = str_replace("\'", "&#39;", $result_all['telephone']); 
                                    $mstatus = $result_all['muqaddimah_status'];
                                    $st_id = $result_all['st_id'];
                                    
                                    
                            ?>
                            <tr>
                                <td><a href="pay_muqaddimah.php?id=<?= $st_id ?>"><?= $student_id ?></a></td>
                                <td><?= $name ?> - <?= $lastname ?></td>
                                <td><?= $year ?></td>
                                <td><?= $telephone ?></td>
                                <td align="center">
                                    <?php
                                        if($mstatus == "1"){ ?>
                                           <font color="green"><b><?php echo "Sudah bayar"; ?><b></font>
                                    <?php   
                                        }else{
                                    ?>
                                        <font color="red"><b><?php echo "Bulum bayar";  ?><b></font>
                                    <?php  
                                        }
                                    ?>
                                </td>
