            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
						...
						<div class="pull-left">
							<form class="navbar-form" role="search" action="no_exam_search.php" method="post">
                        ...
                        <?php 
							...
							$strSQL = "select sx.*,st.*,rx.* from student_register_exam sx inner join students st on sx.st_id = st.st_id inner join register_exam rx on sx.rx_id = rx.rx_id where (stu_id = '".$student_id."')";
