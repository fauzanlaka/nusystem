...
<?php
    $id = $_GET['id'];
    $sql = mysqli_query($con, "DELETE FROM students WHERE st_id='$id'");
?>
...
?>
        <tr>
          ...
          <td align="center"><span class="glyphicon glyphicon-edit"></span> | <a href="?page=student&&studentpage=delete&&id=<?= $id ?>" onclick="return confirm('Anda yakin untuk hapus data ini ?')"><span class="glyphicon glyphicon-remove"></span></a></td>
        </tr>
<?php
    }
?>
