            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <h4><span class="glyphicon glyphicon-book"><b> Daftar ujian</b></span></h4>
                        <hr>
						...
						?>
								...
								<div class="col-sm-12">
									<div class="form-group">
										<table width="100%">
										<tr>
											<td><b>Daftar ujian tahun :</b> <?= $year; ?><b> penggal : </b><?= $term; ?></td>
											<td align="right"><b>Masa daftar : </b> <?= $start_date; ?> <b> Hingga : </b><?= $end_date; ?></td>
										</tr>
										</table>
									</div></div><br><br>
							
							<form class="form-horizontal" role="form" action="<?= saveexamregister(); ?>" enctype="multipart/form-data" method="post"  ><!-- Form -->
									<div class="form-group">
										<label class="col-sm-5">Klik radio button jika mahu daftar :-</label>
									</div>
								<fieldset class="scheduler-border">
									<legend class="scheduler-border"><font color="green" size="2px"><b>Daftar ujian</b></font></legend>
										<div class="form-group">
											<div class="col-sm-3">
												<input type="radio" id="lang_skill1" name="daftar" required> Daftar ujian <b>(<?= $term; ?>/<?= $year; ?>)</b>
											</div>
										</div>
									</fieldset>
								...
								<div align="center">
									...
									<a href="index_register.php"><button type="button" class="btn btn-success" name="save"><span class=""></span> Back</button></a>
							...
							<form class="form-horizontal" role="form" enctype="multipart/form-data"  ><!-- Form -->
								<div class="form-group">
									<div class="col-sm-12">
										<table width="100%">
										<tr>
											<td><b><font color="black">Pendaftaran ujian tahun :</b> <?= $year_q2; ?> <b> penggal ini sudah habis waktu</b></font></td>
										</tr>
										</table>
