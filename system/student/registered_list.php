            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <?php 
							include("connect.php");
							$strSQL = "select sr.*,st.*,re.* from student_register sr inner join students st on sr.st_id = st.st_id inner join register re on sr.re_id = re.re_id ";
						...
						if($Num_Rows<=$Per_Page)
							...
							$strSQL .="order  by sr_id DESC LIMIT $Page_Start , $Per_Page";
							$objQuery  = mysql_query($strSQL);
						?>
