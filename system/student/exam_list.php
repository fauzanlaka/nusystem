            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <?php 
							include("connect.php");
							$strSQL = "select sx.*,st.*,rx.* from student_register_exam sx inner join students st on sx.st_id = st.st_id inner join register_exam rx on sx.rx_id = rx.rx_id ";
						...
						if($Num_Rows<=$Per_Page)
							...
							$strSQL .="order  by srx_id DESC LIMIT $Page_Start , $Per_Page";
							$objQuery  = mysql_query($strSQL);
						?>
