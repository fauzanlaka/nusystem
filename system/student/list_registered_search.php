                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
						...
						<div align="center">
							<?php
								if($daftar == 'Belajar'){ ?>
									<font color="Blue"><b>Meraka yang daftar belajar </b></font> (<?php echo $term ?>/<?php echo $year ?>)
							<?}else{ ?>
									<font color="Blue"><b>Meraka yang daftar periksa </b></font> (<?php echo $term ?>/<?php echo $year ?>)
							<?
								}
							?>
						</div><br>
						Total hasil pencarian : <?php echo $Num_Rows;?> Orang 
				<table>
