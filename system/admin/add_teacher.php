                    ...
                    <div class="caption-full">
						...
						<form class="form-horizontal" role="form" action="<?=$_SERVER['PHP_SELF']?>" method="post"><!-- Form -->
							<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="text" class="form-control" name="tc_code" >
										</div>
							</div>
							...
							<fieldset class="scheduler-border">
								<legend class="scheduler-border"><font color="green"><b>Biodata</b></font></legend>
									<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" class="form-control" id="tc_lastname" name="tc_lastname" >
											</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="code" class="col-sm-2"> No kad pengenalan :</label>
											<div class="col-sm-3">
												<input name="tc_cityzenid" class="form-control">
											</div>
									</div>
									<div class="form-group">
										<label for="code" class="col-sm-2"> No Rumah :</label>
											<div class="col-sm-3">
												<input type="text" class="form-control" id="tc_housenumber" name="tc_housenumber" >
											</div>
										<label for="code" class="col-sm-1"> Kampong</label>
											<div class="col-sm-3">
												<input type="text" class="form-control" id="tc_village" name="tc_village" >
											</div>
									</div>
									<div class="form-group">
										<label for="code" class="col-sm-2"> Tempat :</label>
											<div class="col-sm-2">
												<input type="text" class="form-control" id="tc_placenumber" name="tc_placenumber" >
											</div>
											<div class="col-sm-1">
											</div>
										<label for="code" class="col-sm-1"> Mukim</label>
											<div class="col-sm-3">
												<input type="text" class="form-control" id="tc_subdistrict" name="tc_subdistrict" >
											</div>
									</div>
									<div class="form-group">
										<label for="code" class="col-sm-2"> Dairah :</label>
											<div class="col-sm-3">
												<input type="text" class="form-control" id="tc_districk" name="tc_district" >
											</div>
										<label for="code" class="col-sm-1"> Wilayah</label>
											<div class="col-sm-3">
												<input type="text" class="form-control" id="tc_province" name="tc_province" >
											</div>
									</div>
									<div class="form-group">
										<label for="code" class="col-sm-2"> Kod POS :</label>
											<div class="col-sm-3">
												<input type="text" class="form-control" id="tc_postcode" name="tc_postcode" >
											</div>
