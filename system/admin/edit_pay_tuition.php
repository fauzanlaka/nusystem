            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
						...
						<form class="form-horizontal" role="form" action="function/saveeditpaytuition.php" method="post" enctype="multipart/form-data" ><!-- Form -->
							...
							<fieldset class="scheduler-border">
								...
								<div class="form-group">
									...
									<div class="col-sm-3"><font color="red"><b><i>
											...
											include("connect.php");
                                                                                        $id = $_GET['id'];
											$sql_rc = "SELECT* FROM payments WHERE sr_id = '$id'";
									...
									<label for="code" class="col-sm-3"> Kod resit  : </label>
									<div class="col-sm-3">
										<input type="text" class="form-control" name="receipt" value="<?= $result_rc['reciet_code'] ?>" required>
									</div>
								</div>
                                                                <div class="form-group">
									<div class="col-sm-6"></div>
									...
									<div class="col-sm-3">
										<input type="date" class="form-control" name="pay_date" value="<?= $result_rc['pay_date']; ?>" required>
									</div>
								</div>
