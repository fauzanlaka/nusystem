                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <div class="pull-right">
							...
							<form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="list_registered_search.php"><!-- Form -->
                        ...
                        <?php 
							include("connect.php");
							$strSQL = "select sr.*,st.*,re.* from student_register sr inner join students st on sr.st_id = st.st_id inner join register re on sr.re_id = re.re_id where pay_status = 'Belum bayar' ";
