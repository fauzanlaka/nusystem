...
<head>
    ...
    <title>ADMIN | Ubah data pembukaan pendaftaran</title>
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <h4><span class="glyphicon glyphicon-list-alt"><b> Ubah data pembukaan pendaftaran</b></span></h4>
                        <hr>
                        <!-- Post list -->
					 ...
					 <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="<?= edittuition(); ?>"><!-- Form -->
					 
					 <?php
						include("connect.php");
						$id = $_GET[id];
						$sql = "select * from register where re_id = '$id' ";
					 ...
					 ?>
								...
								<label for="Inputyear" class="col-sm-3">Tahun pengajian :</label>
									<div class="col-sm-2">
										<?php 
												...
												$id = $_GET['id'];
												$sql_r = mysql_query("select * from register where re_id=".$id );
						...
						<div class="form-group">
								<label for="Input_fakulty" class="col-sm-3">Harga daftar umum :</label>
									<div class="col-sm-3">
										<input type="text" name="common_prize" class="form-control" value="<?= $result['common_prize'];?>">
									</div>
						</div>
						
						<div class="form-group">
								<label for="Input_fakulty" class="col-sm-3">Harga daftar khusus :</label>
									<div class="col-sm-3">
										<input type="text" name="special_prize" class="form-control" placeholder="BTH" value="<?= $result['special_prize'];?>">
									</div>
						</div>
