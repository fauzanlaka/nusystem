            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <h4><span class="glyphicon glyphicon-list-alt"><b> Mahasiswa yang daftar untuk ujian</b></span></h4>
                        <hr>
                        <!-- Post list -->
						...
						<div class="pull-left">
							<form class="navbar-form" role="search" action="noexam_registered_search.php" method="post">
                        ...
                        <?php 
							include("connect.php");
							$strSQL = "select sx.*,st.*,rx.* from student_register_exam sx inner join students st on sx.st_id = st.st_id inner join register_exam rx on sx.rx_id = rx.rx_id where pay_status = 'Belum bayar' ";
						...
						if($Num_Rows<=$Per_Page)
							...
							$strSQL .="order  by srx_id ASC LIMIT $Page_Start , $Per_Page";
							$objQuery  = mysql_query($strSQL);
						?>
               		...
               		<table class="table table-hover">
						...
						<?php
							...
							$year = str_replace("\'", "&#39;", $objResult['year']);
							$term = str_replace("\'", "&#39;", $objResult['term']);
						?>
                          <tr>        
                             <td align="center"><a href="exam_pay.php?id=<?= $objResult['srx_id']; ?>"><?= $student_id; ?></a></td>
