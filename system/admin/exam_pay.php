									...
									<div class="col-sm-3">
										...
										?>
											...
											<div align="center">
												...
												<a href="exam_reciet.php?id=<?= $result['srx_id']; ?>" target="_blank"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-print"></span> Print resit</button></a>
											</div>
						</form>
