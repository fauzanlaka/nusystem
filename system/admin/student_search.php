    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <h4><span class="glyphicon glyphicon-list-alt"><b> Daftar mahasiswa</b></span></h4>
                        <hr>
                        <!-- Post list -->
						...
						<div class="pull-left">
							<form class="navbar-form" role="search" action="student_search.php" method="post">
								<div class="input-group">
									<input type="text" class="form-control" placeholder="Nanma atau nomor pokok" name="q" required>
                        ...
                        <?php 
                            include("connect.php");
                            $term = $_POST['q'];
                            $strSQL = "SELECT s.*,f.* FROM students s INNER JOIN fakultys f on  s.ft_id = f.ft_id WHERE student_id LIKE '%".$term."%' or firstname_rumi LIKE '%".$term."%' or cityzen_id LIKE '%".$term."%' or firstname_jawi LIKE '%".$term."%' or lastname_jawi LIKE '%".$term."%'";
			...
			<?php
                            ...
                            $ft_name = str_replace("\'", "&#39;", $objResult['ft_name']);
                            $telephone = str_replace("\'", "&#39;", $objResult['telephone']);
                            $email = str_replace("\'", "&#39;", $objResult['email']);
			?>
                            <tr>        
                                <td><a href="student_data.php?id=<?= $objResult['st_id']; ?>"><?= $student_id; ?></a></td>
                                <td><?= $firstname_rumi; ?> -  <?= $lastname_rumi; ?></td>
                                <td><?= $ft_name; ?></td>
                                <td align="center"><?= $telephone; ?></td>
                                <td align="left"><?= $email; ?></td>
                                <td align="center"><a href="function/delete_student.php?id=<?= $objResult['st_id']; ?>" onclick="return confirm('Anda yakin untuk hapus data ini?');"><span class="glyphicon glyphicon-trash"></span></a></td>
                            </tr>
						<?php } ?>
                        </table>
			<div align="center">
                            <a href="student_list.php"><button type="button" class="btn btn-success" ><span class="glyphicon glyphicon-arrow-left"></span> Back </span></button></a>
			</div>
