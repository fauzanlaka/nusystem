...
<head>
    ...
    <title>ADMIN | Daftar jurusan</title>
...
?>
                        ...
                        <h4><span class="glyphicon glyphicon-bookmark"><b> Daftar jurusan</b></span></h4>
                        <hr>
                        <p>
                        <!-- Post list -->
                        ...
                        <table class="table table-hover">
                            ...
                            <?php
									include("connect.php");
									//$sql = "select ft_id,dp_id,dp_name,ft_name, from fakultys join departments on fakultys.ft_id = departments.ft_id";
									$sql = "select * from departments inner join fakultys on departments.ft_id=fakultys.ft_id";
                            ...
                            <tr>
                                ...
                                <td><?= $dp_name ?></td>
								<td><?= $ft_name ?></td>
                                <td align="center"><a href="edit_department.php?id=<?= $result[dp_id];?>"><span class="glyphicon glyphicon-edit"></span></a></td>
                                <td align="center"><a href="function/department_delete.php?id=<?= $result['dp_id'];?>"><span class="glyphicon glyphicon-trash"></span></button></a></td>
                            </tr>
                            <? } ?>
						</table>
                        </p>
