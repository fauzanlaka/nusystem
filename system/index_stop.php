            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption-full">
                        ...
                        <?php
							include("connect.php");
							$sql = "select * from post where publish='1' or publish='2' order by p_id DESC LIMIT 0,15";
							$query = mysql_query($sql);
						
							while($result = mysql_fetch_array($query)){
						?>
                        
                        - <a href="show_post.php?id=<?= $result['p_id']; ?>"><d class="serif"><font color="red"> <b><?= $result['p_title']; ?></b></font></d></a> , <d class="sansserif"><i><?= $result['p_author']; ?> <?= $result['p_date']; ?></i></d> <br>                        
                        <? } ?>
                        </p>
                        </p>
