			...
			<div class="post-wrapper">
				...
				<?php if (get_option('whoswho_468_enable') == 'on') { ?>
					...
					<?php if(get_option('whoswho_468_adsense') <> '') echo(get_option('whoswho_468_adsense'));
						...
						<a href="<?php echo esc_url(get_option('whoswho_468_url')); ?>" class="foursixeight_link"><img src="<?php echo esc_url(get_option('whoswho_468_image')); ?>" alt="468 ad" class="foursixeight" /></a>
					<?php } ?>	
				<?php } ?>
