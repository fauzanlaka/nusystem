...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		#left-inside a { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		#pages ul li a:link, #pages ul li a:visited, #pages ul li a:active, #categories ul li a:link, #categories ul li a:visited, #categories ul li a:active { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		#pages ul li a:hover, #categories ul li a:hover { color: #<?php echo(get_option($shortname.'_color_pagelink_active')); ?>; }
		...
		#footer { color:#<?php echo(get_option($shortname.'_footer_headings')); ?> }
