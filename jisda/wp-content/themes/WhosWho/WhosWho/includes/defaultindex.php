<?php if (is_home() && get_option('whoswho_blog_style') == 'on') { ?>
		<?php $args=array(
			'showposts'=> (int) get_option('whoswho_homepage_posts'),
			'paged'=>$paged,
			'category__not_in' => (array) get_option('whoswho_exlcats_recent'),
		);
		query_posts($args); ?>
<?php } ?>
