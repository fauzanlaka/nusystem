...
<div id="featured-div">
    ...
    <div id="feautred-article">
        <?php $ids = array();
			  $featured_cat = get_option('whoswho_feat_cat');
			  query_posts("showposts=1&cat=".get_catId($featured_cat));
    ...
    <div style="float: left; margin-left: 5px; margin-top: 15px;">
        ...
        <div id="scrollable">
            ...
            <div class="items">
                <?php query_posts("orderby=rand&showposts=".get_option('whoswho_random_num'));
					  while (have_posts()) : the_post(); ?>
							<?php $thumb = '';  	  
								  $width = 60;
								  $height = 60;
        ...
        <img src="<?php bloginfo('template_directory'); ?>/images/rounded-bottom.gif" alt="bottom" style="float: left;" />
        <!--End Random Articles-->
        <div style="clear: both;"></div>
        ...
        <div id="scrollable2" style="margin-top: 10px;">
            ...
            <div style="float: left; margin-top: 5px; width: 100%;"> <a href="<?php bloginfo('rss2_url'); ?>" rel="bookmark" title="RSS"><img src="<?php bloginfo('template_directory'); ?>/images/rss.gif" alt="rss" style="border: none; margin-right: 8px; margin-bottom: -4px;" />RSS 2.0 </a> <a href="<?php bloginfo('atom_url'); ?>" rel="bookmark" title="RSS"><img src="<?php bloginfo('template_directory'); ?>/images/rss.gif" alt="rss" style="border: none; margin-right: 8px; margin-bottom: -4px;" />Atom </a> <a href="<?php bloginfo('comments_rss2_url'); ?>" rel="bookmark" title="RSS"><img src="<?php bloginfo('template_directory'); ?>/images/rss.gif" alt="rss" style="border: none; margin-right: 8px; margin-bottom: -4px;" />Comments RSS</a> <a href="<?php bloginfo('rdf_url'); ?>" rel="bookmark" title="RSS"> <img src="<?php bloginfo('template_directory'); ?>/images/rss.gif" alt="rss" style="border: none; margin-right: 8px; margin-bottom: -4px;" /> RSS/RDF 1.0</a> </div>
            <div style="clear: both;"></div>
        </div> <!-- end #scrollable2 -->
        <img src="<?php bloginfo('template_directory'); ?>/images/rounded-bottom.gif" alt="bottom" style="float: left;" />
        <!--End RSS Section-->
