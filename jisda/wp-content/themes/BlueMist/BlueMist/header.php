	...
	<div id="header">
		<div id="header-left">
			<a href="<?php bloginfo('url'); ?>">
				<?php $logo = (get_option('bluemist_logo') <> '') ? get_option('bluemist_logo') : get_bloginfo('template_directory').'/images/logo.gif'; ?>
		...
		<img src="<?php bloginfo('template_directory'); ?>/images/nav-left.gif" alt="nav-left" class="nav-image"  style="margin-left: 10px;" />
		<div id="pages">
			<?php $menuClass = '';
			$primaryNav = '';
		...
		<img src="<?php bloginfo('template_directory'); ?>/images/nav-right.gif" class="nav-image" alt="nav-left" />
		...
		<div id="recent">
			...
			<div id="recent-right">
				<div id="aboutus">
					<span class="toptitle2"><img src="<?php bloginfo('template_directory'); ?>/images/icon-about.gif" alt="icon comments" class="icons" /><?php esc_html_e('About Us','Bluemist'); ?></span>
