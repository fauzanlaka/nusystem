...
(function() {
	...
	tinymce.create('tinymce.plugins.udsGmap', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addButton('udsGmap', {
				title : 'Create a styled Gmap',
				cmd : 'mceGmap',
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Gmap Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsGmap', tinymce.plugins.udsGmap);
})();