...
(function() {
	...
	tinymce.create('tinymce.plugins.udsFlickr', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addButton('udsFlickr', {
				title : 'Create a styled Flickr',
				cmd : 'mceFlickr',
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Flickr Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsFlickr', tinymce.plugins.udsFlickr);
})();