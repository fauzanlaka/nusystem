...
(function() {
	...
	tinymce.create('tinymce.plugins.udsTab', {
		/**
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Tab Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsTab', tinymce.plugins.udsTab);
})();