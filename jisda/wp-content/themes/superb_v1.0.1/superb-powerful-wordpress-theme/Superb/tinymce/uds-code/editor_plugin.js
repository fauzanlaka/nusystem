...
(function() {
	...
	tinymce.create('tinymce.plugins.udsCode', {
		/**
...
*/
			...
			ed.addButton('udsCode', {
				title : 'Make text appear as code',
				cmd : 'mceCode',
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Code Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsCode', tinymce.plugins.udsCode);
})();