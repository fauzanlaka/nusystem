...
(function() {
	...
	tinymce.create('tinymce.plugins.udsHighlight', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addButton('udsHighlight', {
				title : 'Hihghlight selected text',
				cmd : 'mceHighlight',
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Highlight Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsHighlight', tinymce.plugins.udsHighlight);
})();