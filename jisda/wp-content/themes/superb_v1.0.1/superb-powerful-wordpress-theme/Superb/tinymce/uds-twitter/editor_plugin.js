...
(function() {
	...
	tinymce.create('tinymce.plugins.udsTwitter', {
		/**
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Twitter Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsTwitter', tinymce.plugins.udsTwitter);
})();