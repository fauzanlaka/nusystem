...
(function() {
	...
	tinymce.create('tinymce.plugins.udsTabs', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addButton('udsTabs', {
				title : 'Create interactive Tabs',
				cmd : 'mceTabs',
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Tabs Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsTabs', tinymce.plugins.udsTabs);
})();