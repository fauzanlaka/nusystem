...
class UDS_Ads extends WP_Widget {
	function UDS_Ads() {
		//Constructor
		$options = array(
			'description' => __('uAd widget', 'uds-textdomain')
		);
		parent::__construct('uds-ads', __('UDS Ads Widget', 'uds-textdomain'));
	}
		...
		?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('resolution'); ?>">
					<?php _e('Resolution', 'uds-textdomain') ?>: 
