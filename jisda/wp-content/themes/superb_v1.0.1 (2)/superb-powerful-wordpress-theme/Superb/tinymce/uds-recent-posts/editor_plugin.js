...
(function() {
	...
	tinymce.create('tinymce.plugins.udsRecentPosts', {
		/**
		...
		init : function(ed, url) {
			...
			// box
			ed.addCommand('mceRecentPosts', function() {
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Recent Posts Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsRecentPosts', tinymce.plugins.udsRecentPosts);
})();