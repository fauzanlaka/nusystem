...
(function() {
	...
	tinymce.create('tinymce.plugins.udsSocial', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addButton('udsSocial', {
				title : 'Create a styled Social',
				cmd : 'mceSocial',
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Social Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsSocial', tinymce.plugins.udsSocial);
})();