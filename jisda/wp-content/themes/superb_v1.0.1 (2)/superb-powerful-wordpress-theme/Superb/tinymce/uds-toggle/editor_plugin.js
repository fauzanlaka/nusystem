...
(function() {
	...
	tinymce.create('tinymce.plugins.udsToggle', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addButton('udsToggle', {
				title : 'Insert Interactive Toggle',
				cmd : 'mceToggle',
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Toggle Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsToggle', tinymce.plugins.udsToggle);
})();