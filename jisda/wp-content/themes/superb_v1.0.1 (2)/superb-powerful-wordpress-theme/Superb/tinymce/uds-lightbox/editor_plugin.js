...
(function() {
	...
	tinymce.create('tinymce.plugins.udsLightbox', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addButton('udsLightbox', {
				title : 'Create an interactive Lightbox',
				cmd : 'mceLightbox',
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Lightbox Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsLightbox', tinymce.plugins.udsLightbox);
})();