...
(function() {
	...
	tinymce.create('tinymce.plugins.udsList', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addButton('udsList', {
				title : 'Create a styled List',
				cmd : 'mceList',
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios List Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsList', tinymce.plugins.udsList);
})();