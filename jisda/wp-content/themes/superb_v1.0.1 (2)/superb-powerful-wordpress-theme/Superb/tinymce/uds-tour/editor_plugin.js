...
(function() {
	...
	tinymce.create('tinymce.plugins.udsTour', {
		/**
		...
		init : function(ed, url) {
			...
			// box
			ed.addCommand('mceTour', function() {
			...
			ed.addButton('udsTour', {
				title : 'Create a styled Tour',
				cmd : 'mceTour',
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Tour Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsTour', tinymce.plugins.udsTour);
})();