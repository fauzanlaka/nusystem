...
(function() {
	...
	tinymce.create('tinymce.plugins.udsAccordion', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addButton('udsAccordion', {
				title : 'Create a styled Accordion',
				cmd : 'mceAccordion',
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Accordion Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsAccordion', tinymce.plugins.udsAccordion);
})();