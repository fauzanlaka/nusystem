...
(function() {
	...
	tinymce.create('tinymce.plugins.udsTourpage', {
		/**
		...
		init : function(ed, url) {
			...
			// box
			ed.addCommand('mceTourpage', function() {
			...
			ed.addButton('udsTourpage', {
				title : 'Create a styled Tourpage',
				cmd : 'mceTourpage',
		...
		getInfo : function() {
			return {
					longname  : 'uDesignStudios Tourpage Plugin',
	...
	// Register plugin
	tinymce.PluginManager.add('udsTourpage', tinymce.plugins.udsTourpage);
})();