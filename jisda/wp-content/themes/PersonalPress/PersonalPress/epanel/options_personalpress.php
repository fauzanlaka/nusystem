...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		#main a { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		ul.nav li a strong, ul.nav li a span { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		ul.nav li a:hover, ul.nav li a:hover strong, ul.nav li a:hover span, ul.nav > li.current-cat > a strong, ul.nav > li.current-cat > a span, ul.nav > li.current_page_item > a strong, ul.nav > li.current_page_item > a span, ul.nav > li.current-menu-item > a span, ul.nav > li.current-menu-item > a strong { color: #<?php echo(get_option($shortname.'_color_pagelink_active')); ?>; }
		...
		#footer a { color:#<?php echo(get_option($shortname.'_color_footerlinks')); ?> !important; }
	</style>
