...
<?php
  ...
  /*Saves the settings. */
    function update($new_instance, $old_instance){
		...
		$instance['bannerNinePath'] = stripslashes($new_instance['bannerNinePath']);
		$instance['bannerNineUrl'] = stripslashes($new_instance['bannerNineUrl']);
		
		$instance['bannerTenPath'] = stripslashes($new_instance['bannerTenPath']);
		$instance['bannerTenUrl'] = stripslashes($new_instance['bannerTenUrl']);
		
		$instance['bannerElevenPath'] = stripslashes($new_instance['bannerElevenPath']);
		$instance['bannerElevenUrl'] = stripslashes($new_instance['bannerElevenUrl']);
		
		$instance['bannerTwelvePath'] = stripslashes($new_instance['bannerTwelvePath']);
		$instance['bannerTwelveUrl'] = stripslashes($new_instance['bannerTwelveUrl']);
  ...
  /*Creates the form for the widget in the back-end. */
    function form($instance){
		...
		$bannerPath[9] = esc_url($instance['bannerNinePath']);
		$bannerUrl[9] = esc_url($instance['bannerNineUrl']);
		
		$bannerPath[10] = esc_url($instance['bannerTenPath']);
		$bannerUrl[10] = esc_url($instance['bannerTenUrl']);
		
		$bannerPath[11] = esc_url($instance['bannerElevenPath']);
		$bannerUrl[11] = esc_url($instance['bannerElevenUrl']);
		
		$bannerPath[12] = esc_url($instance['bannerTwelvePath']);
