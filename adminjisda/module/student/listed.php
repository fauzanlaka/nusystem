<?php
    $pagic = "?page=student&&studentpage=listed";
...
<div class="pull-right">
        <form class="navbar-form" role="search" action="?page=student&&studentpage=searched" method="post">
...
?>
        <tr>
          <td align="center"><a href="?page=student&&studentpage=edited&&id=<?= $id ?>"><?= $student_id ?></a></td>
