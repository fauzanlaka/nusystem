...
$sql = mysqli_query($con, "INSERT INTO 
                ...
                values ('$student_id','$income_year','$ft_id','$dp_id','$firstname_rumi','$lastname_rumi',
                        ...
                        '$thai_lang_skill','$certificate','$citizen_book','$id_book','$photo','$password')
            ");
    ...
    header("location:main.php?page=student&&studentpage=addthaistudent&&id=$id");
    break;
?>